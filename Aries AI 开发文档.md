...
|--------|-------------|-----|--------|---------|-----------|---------|--------|------|
| **1.2.0** (当前) | 12 | 8.13.2 | 2.0.21 | 30 | 36 | 2026-01-13 | Aries 协议对齐、Markdown 渲染统一、流式解析增强、小窗稳定性 | 现网 |
...
- ✅ **版本号** — App 1.2.0 (versionCode 12, targetSdk 36, AGP 8.13.2, Kotlin 2.0.21)
...
| 模块 | 最新版本 | 最新日期 | 改进摘要 |
|------|---------|--------|--------|
| **流式解析** | 1.2.0 | 2026-01-11 | AriesStreamParser 增强、Aries 标记对齐、吞掉标记 |
| **Markdown 渲染** | 1.2.0 | 2026-01-11 | Markwon 统一、历史消息渲染修复、复制功能优化 |
| **小窗实现** | 1.2.0 | 2026-01-09 | 回退稳定版、ACK 机制、防闪优化（120ms延迟） |
| **消息同步** | 1.2.0 | 2026-01-02 | 双向队列同步、前缀兼容、监听器生命周期优化 |
| **UI 交互** | 1.2.0 | 2026-01-02 | Drawer 右滑打开、输入框焦点争抢修复 |
| **自动化执行** | 1.2.0 | 2026-01-05 | 应用直启（1s启动）、敏感检测优化、百分比进度 |
| **对话管理** | 1.2.0 | 2026-01-08 | 上下文完整性、批量刷新、消息气泡操作区修复 |
| **权限体系** | 1.1.x | 2026-01-01 | 首次启动权限引导、后台权限检查 |
| **工程构建** | 1.2.0 | 2026-01-01 | 移除 ktlint、修复 Gradle 同步 |
| **虚拟屏交互** | 1.2.0 | 2026-02-16 | 关闭按钮联动、分辨率对齐、状态刷新、输入源管理（待修复） |
